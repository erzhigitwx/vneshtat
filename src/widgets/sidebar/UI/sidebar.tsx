...
const Sidebar = () => {
    return (
        <div className={"flex flex-col gap-5 items-center"}>
            ...
            <div className={"flex flex-col py-8 px-5 gap-9 bg-primary rounded-primary"}>
                <div className={"flex flex-col gap-9"}>
                    <Link to={"/"}>
                        <HomeImg className={"blue-fill-hover"}/>
                    </Link>
                    <Link to={"/"}>
                        <SwapImg className={"blue-fill-hover"}/>
                    </Link>
                    <Link to={"/"}>
                        <CopyImg className={"blue-fill-hover"}/>
                    </Link>
                </div>
                <hr className={"h-[1px] w-full bg-[#e5e7ea]"}/>
                <div className={"flex flex-col gap-9"}>
                    <Link to={"/"}>
                        <MessageImg className={"blue-fill-hover"}/>
                    </Link>
                    <Link to={"/"}>
                        <JobImg className={"blue-fill-hover"}/>
                    </Link>
                </div>
                <hr className={"h-[1px] w-full bg-[#e5e7ea]"}/>
                <div className={"flex flex-col gap-9"}>
                    <Link to={"/"}>
                        <ScopeImg className={"blue-fill-hover"}/>
                    </Link>
                    <Link to={"/"}>
                        <FilterImg className={"blue-fill-hover"}/>
                    </Link>
                </div>
                <hr className={"h-[1px] w-full bg-[#e5e7ea]"}/>
                <div>
                    <RightImg className={"blue-fill-hover"}/>
                </div>
            </div>
            <div className={"w-14 h-14 rounded-[23px] flex justify-center items-center bg-black"}>
