    ...
    return (
        <div className={"h-[calc(100vh-120px)] px-[100px] py-[60px] bg-section"}>
            <header className={"flex items-center justify-between h-10"}>
                ...
                <div className={"flex items-center gap-2"}>
                    <button className={"h-10 px-10 py-2 flex items-center justify-center border border-solid border-[#9B9FAD] rounded-[14px]"}>
                        <p className={"text-[17px] text-[#9B9FAD]"}>Войти</p>
                    </button>
                    <button className={"h-10 px-10 py-2 flex items-center justify-center rounded-[14px] bg-[#292933]"} onClick={() => dispatch(setIsOpen(true))}>
