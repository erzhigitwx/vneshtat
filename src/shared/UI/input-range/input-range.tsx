...
const InputRange: React.FC<InputRangeProps> = ({ extraClass, min, max, onChangeValue = () => {}, isTime = false }: InputRangeProps) => {
    ...
    return (
        <div className={`container ${extraClass}`}>
            ...
            />
            <div className="thumb-indicator" style={{ left: `${getPercent(minVal)}%` }} />
            ...
            />
            <div className="thumb-indicator" style={{ left: `${getPercent(maxVal)}%` }} />
